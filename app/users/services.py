...
class UserService(UserServiceBase):
    ...
    async def update_user_password(self, id: UUID, data: UserUpdate) -> User:
        """
        ...
        updated_user: User = await self.repository.update_by_attribute(data, id)
...
class UserAdminService(UserServiceBase):
    ...
    async def update_user_username(self, id: UUID, data: UserUpdate) -> User:
        """
    ...
    async def update_user_roles(self, id: UUID, data: UserUpdate) -> User:
        """
